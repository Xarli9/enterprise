...
public class StudentDao implements IDao<Student>{
    ...
    public int add(Student model) throws SQLException {
        ...
        String query = "INSERT INTO STUDENT (name, surname, card_id) VALUES (? ,?, ?)";
    ...
    public int delete(Student model) throws SQLException{
        ...
        String query = "DELETE FROM STUDENT WHERE card_id = ?";
    ...
    public int update(Student model) throws SQLException {
        ...
        String query = "UPDATE STUDENT SET name = ?, surname = ?, card_id = ?"
                + " WHERE student_id = ?";
